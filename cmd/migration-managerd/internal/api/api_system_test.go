...
func TestNetworkUpdate(t *testing.T) {
	cases := []struct {
		...
		{
			name:           "success - worker endpoint inherits default network port",
			initConfig:     api.SystemNetwork{},
			config:         api.SystemNetwork{Address: "::", WorkerEndpoint: "https://11.11.11.11"},
			wantConfig:     api.SystemNetwork{Address: "[::]:6443", WorkerEndpoint: "https://11.11.11.11:6443"},
			wantHTTPStatus: http.StatusOK,
		},
		{
			name:           "success - worker endpoint inherits default network port with trailing colon",
			initConfig:     api.SystemNetwork{},
			config:         api.SystemNetwork{Address: "::", WorkerEndpoint: "https://11.11.11.11:"},
			wantConfig:     api.SystemNetwork{Address: "[::]:6443", WorkerEndpoint: "https://11.11.11.11:6443"},
			wantHTTPStatus: http.StatusOK,
		...
		{
			name:           "success - worker endpoint inherits existing network port",
			initConfig:     api.SystemNetwork{Address: "[::]:6444"},
			config:         api.SystemNetwork{Address: "[::]:6444", WorkerEndpoint: "https://11.11.11.11"},
			wantConfig:     api.SystemNetwork{Address: "[::]:6444", WorkerEndpoint: "https://11.11.11.11:6444"},
			wantHTTPStatus: http.StatusOK,
		},
		{
			name:           "success - worker endpoint inherits explicit network port",
			initConfig:     api.SystemNetwork{},
			config:         api.SystemNetwork{Address: "[::]:6444", WorkerEndpoint: "https://11.11.11.11:"},
			wantConfig:     api.SystemNetwork{Address: "[::]:6444", WorkerEndpoint: "https://11.11.11.11:6444"},
			wantHTTPStatus: http.StatusOK,
