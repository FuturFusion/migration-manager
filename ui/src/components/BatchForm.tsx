...
const BatchForm: FC<Props> = ({ batch, onSubmit }) => {
  ...
  const [isSectionVisible, setIsSectionVisible] = useState<SectionState>({
    placement: false,
    settings: false,
  });

  const toogleSection = (field: keyof SectionState) => {
    setIsSectionVisible({
      ...isSectionVisible,
      [field]: !isSectionVisible[field],
    });
  };

  const sectionSwitch = (field: keyof SectionState) => {
    return (
  ...
  const validateForm = (
    ...
    if (
      ...
      setIsSectionVisible({ ...isSectionVisible, placement: true });
    }
        ...
        <Form noValidate>
            ...
            <div className="ps-3">
              ...
              <Form.Group className="mb-3" controlId="constraints">
                ...
                <BatchConstraintsWidget
                  ...
                  onChange={(value) =>
                    formik.setFieldValue("constraints", value)
                  }
                />
                <Form.Control.Feedback
                  type="invalid"
          ...
          <fieldset className="mb-4">
            <legend
              ...
              onClick={() => toogleSection("placement")}
              className="h4"
            >
              Placement {sectionSwitch("placement")}
            </legend>
            {isSectionVisible["placement"] && (
              <div className="ps-3 pt-3">
                ...
                <Form.Group className="mb-3" controlId="migration_network">
                  ...
                  <Form.Control.Feedback
                    ...
                    style={{ whiteSpace: "pre-line" }}
                  >
                    {typeof formik.errors.defaults?.migration_network ===
                      "string" && formik.errors.defaults?.migration_network}
                  </Form.Control.Feedback>
                </Form.Group>
                ...
                <Form.Group className="mb-3" controlId="rerun_scriptlets">
                  ...
                  <Form.Select
                    ...
                    value={
                      formik.values.config.rerun_scriptlets ? "true" : "false"
                    }
                    onChange={(e) =>
          ...
          <fieldset className="mb-4">
            <legend
              style={{ cursor: "pointer" }}
              onClick={() => toogleSection("settings")}
              className="h4"
            >
              Settings {sectionSwitch("settings")}
            </legend>
            {isSectionVisible["settings"] && (
              <div className="ps-3 pt-3">
                ...
                <Form.Group className="mb-3" controlId="allow_no_ipv4">
                  <Form.Label>Allow missing IPv4</Form.Label>
                  <Form.Select
                ...
                <Form.Group
                  className="mb-3"
                  controlId="allow_no_background_import"
                >
                  <Form.Label>Allow missing background import</Form.Label>
                  <Form.Select
                ...
                <Form.Group
                  className="mb-3"
                  controlId="finalBackgroundSyncLimit"
                >
