...
test('renders base TabView', () => {
  ...
  render(<TabView defaultTab='tab1' activeTab='tab1' tabs={ tabs } onSelect={handleSelect}/>);
...
test('renders TabView with selected second tab', () => {
  ...
  const handleSelect = vi.fn();
  render(<TabView defaultTab='tab1' activeTab='tab2' tabs={ tabs } onSelect={handleSelect} />);
