...
`),
			...
			repoCreateSource: migration.Source{
				...
				Name:       "one",
				SourceType: api.SOURCETYPE_VMWARE,
				Properties: json.RawMessage(`{"endpoint":"endpoint.url","username":"user","password":"pass","connectivity_status":"OK","connection_timeout":"10s","datacenters":["/..."]}`),
			},
...
`),
			...
			repoCreateSource: migration.Source{
				...
				Name:       "one",
				SourceType: api.SOURCETYPE_NSX,
				Properties: json.RawMessage(`{"endpoint":"endpoint.url","username":"user","password":"pass","connectivity_status":"OK","connection_timeout":"10s","datacenters":["/..."],"compute_managers":null,"segments":null,"edge_nodes":null,"policies":null}`),
			},
...
`),
			...
			repoCreateSource: migration.Source{
				...
				Name:       "one",
				SourceType: api.SOURCETYPE_VMWARE,
				Properties: json.RawMessage(`{"endpoint":"endpoint.url","username":"user","password":"pass","connectivity_status":"OK","connection_timeout":"5s","datacenters":["/dc1/...","/dc2/...","/dc3/..."]}`),
			},
