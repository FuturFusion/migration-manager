...
func (s source) Create(ctx context.Context, in migration.Source) (migration.Source, error) {
	const sqlInsert = `
INSERT INTO sources (name, source_type, insecure, properties, connectivity_status)
VALUES(:name, :source_type, :insecure, :properties, :connectivity_status)
RETURNING id, name, source_type, insecure, properties, connectivity_status;
`
...
func (s source) GetAll(ctx context.Context) (migration.Sources, error) {
	const sqlGetAll = `SELECT id, name, source_type, insecure, properties, connectivity_status FROM sources ORDER BY name;`
...
func (s source) GetByID(ctx context.Context, id int) (migration.Source, error) {
	const sqlGetByID = `SELECT id, name, source_type, insecure, properties, connectivity_status FROM sources WHERE id=:id;`
...
func (s source) GetByName(ctx context.Context, name string) (migration.Source, error) {
	const sqlGetByName = `SELECT id, name, source_type, insecure, properties, connectivity_status FROM sources WHERE name=:name;`
...
func (s source) UpdateByID(ctx context.Context, in migration.Source) (migration.Source, error) {
	const sqlUpdate = `
UPDATE sources SET name=:name, insecure=:insecure, source_type=:source_type, properties=:properties, connectivity_status=:connectivity_status
WHERE id=:id
RETURNING id, name, source_type, insecure, properties, connectivity_status;
`
