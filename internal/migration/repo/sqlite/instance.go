...
func (i instance) GetAllInRunningBatches(ctx context.Context) (migration.Instances, error) {
	return entities.GetInstancesInRunningBatches(ctx, transaction.GetDBTX(ctx, i.db))
}
