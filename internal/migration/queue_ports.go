...
type QueueService interface {
	...
	CancelByUUID(ctx context.Context, id uuid.UUID) (*QueueEntry, bool, error)
	RetryByUUID(ctx context.Context, id uuid.UUID, networkSvc NetworkService) (*QueueEntry, error)
