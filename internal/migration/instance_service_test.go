...
func TestInstanceService_Create(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			instance: migration.Instance{
				UUID:                 uuidA,
				Properties:           api.InstanceProperties{Location: "/inventory/path", InstancePropertiesConfigurable: api.InstancePropertiesConfigurable{Name: "path"}},
...
func TestInstanceService_Update(t *testing.T) {
	tests := []struct {
		...
		},
		{
			...
			instance: migration.Instance{
				UUID:       uuidA,
				Properties: api.InstanceProperties{Location: "/inventory/path", InstancePropertiesConfigurable: api.InstancePropertiesConfigurable{Name: "path", Architecture: "x86_64"}, OS: "os", OSVersion: "os_version", BackgroundImport: true},
				Overrides:  api.InstanceOverride{Comment: "edited instance"},
