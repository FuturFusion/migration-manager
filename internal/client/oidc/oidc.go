...
func (o *OidcClient) Do(req *http.Request) (*http.Response, error) {
	...
	issuer := resp.Header.Get("X-MigrationManager-OIDC-issuer")
	clientID := resp.Header.Get("X-MigrationManager-OIDC-clientid")
	audience := resp.Header.Get("X-MigrationManager-OIDC-audience")
