...
var (
	incusTargetA = target.NewIncusTarget("Target A", "https://localhost:6443")
	incusTargetB = target.NewIncusTarget("Target B", "https://incus.local:6443")
	incusTargetC = target.NewIncusTarget("Target C", "https://10.10.10.10:6443")
)
